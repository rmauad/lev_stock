...
#     grouped = df_subsample.groupby(['year_month', quant_dlev_col])
#     ret_lead1_rf_avg = grouped.apply(lambda x: (x['ret_lead1_rf'] * x['me']).sum() / x['me'].sum()).reset_index(name=f'ret_lead1_rf')    
#     ret_lead1_rf_avg = ret_lead1_rf_avg.set_index(['year_month', quant_dlev_col])['ret_lead1_rf']
