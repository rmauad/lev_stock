...
# pf.reg_factor(df_factor_all, quant_intan, quant_dlev, quant_lev, quant_size, quant_bm, window_fac_betas, model_factor, port_ff25_pivot, filename = f'reg_factor_{model_factor}.tex')
